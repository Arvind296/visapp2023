...
import { PreviousRouteService, CommonService, UserService } from 'src/app/core';
declare var $:any ;
@Component({
...
if( localStorage.getItem("lang")){
 ...
 Lang = 'en';
  ...
  constructor(  private previousRouteService: PreviousRouteService, private spinnerService: Ng4LoadingSpinnerService,private adalSvc: MsAdalAngular6Service,public commonService: CommonService,
